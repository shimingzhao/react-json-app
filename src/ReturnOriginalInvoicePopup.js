          ...
          <div id='invoicePopupBody' ref={el => (this.componentRef = el)}>
            ...
            <div className='invoicePopupCustomer'>
              ...
              >
                ...
                <span style={{display:otherorder.ORDERDETAILS[0].CUSTOMERSHIPTO.AREACODE?'':'none'}}>Tel: ({otherorder.ORDERDETAILS[0].CUSTOMERSHIPTO.AREACODE}){otherorder.ORDERDETAILS[0].CUSTOMERSHIPTO.PRIMARYTEL}</span>
              </div>
            ...
            <div className='invoicePopupMount'>
              ...
              <div className='invoicePopupMount_style2'>${otherorder.TAX1.toFixed(2)}</div>
