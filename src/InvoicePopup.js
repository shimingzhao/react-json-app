          ...
          <div id='invoicePopupBody' ref={el => (this.componentRef = el)}>
            ...
            <div className='invoicePopupCustomer'>
              <div className='popupInfo' style={{
                ...
                <span style={{display:order.ORDERDETAILS[0].CUSTOMERSHIPTO.AREACODE?'':'none'}}>Tel: ({order.ORDERDETAILS[0].CUSTOMERSHIPTO.AREACODE}){order.ORDERDETAILS[0].CUSTOMERSHIPTO.PRIMARYTEL}</span>
              </div>
                ...
                return (
                  <div className='invoicePopupItems' key={index}>
                    <div className='invoicePopupShipto'>
                      <div>{item.DESC_1.toUpperCase()}</div>
                      <div
                        style={{display: item.CUSTOMERSHIPTO.NAME1 && item.COORDINATEGRP !== 'NA' ? '' : 'none'}}>
                        SHIP TO: &nbsp;&nbsp;
                        {
            ...
            <div className='invoicePopupMount'>
              ...
              <div className='invoicePopupMount_style2'>${order.TAX1.toFixed(2)}</div>
